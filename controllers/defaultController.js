...
module.exports.getTopicPosts = async (req, res) => {
  ...
  res.render("default/catagory", { posts: posts });
};

module.exports.getQuestion = async (req, res) => {
  console.log(req.query.data);
  let question = req.query.data;
  res.render("default/question", { questions: question });
};
module.exports.getAnswer = async (req, res) => {
  console.log(req.query.data);
  let answer = req.query.data;
  res.render("default/answer", { answer });
};
